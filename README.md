...
To see walk through on how the results were collected and visualized, checko out their respective notebooks; [predictions](https://github.com/dkeogh1/time-series-covid/blob/master/macro_predictions.ipynb) and [visuals](https://github.com/dkeogh1/time-series-covid/blob/master/Prediction_Visuals.ipynb).
